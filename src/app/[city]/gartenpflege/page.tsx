...
export default async function CityGartenpflegePage({ params }: { params: Promise<{ city: string }> }) {
    ...
    return (
        <>
                ...
                <div className="container-custom py-1.5">
                    <nav className="flex items-center justify-between">
                        <Link href="/" className="flex items-center gap-3">
                            <img src="/images/logo.png" alt="Adler & Sohn Galabau" className="h-10 w-auto object-contain" />
                        </Link>
            ...
            <main>
                {/* Hero - using CSS background instead of next/image to avoid SSR image optimization timeout */}
                <section className="relative pt-32 pb-20 overflow-hidden" style={{ backgroundImage: 'url(/images/gartenpflege-hero.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="absolute inset-0 bg-gradient-to-br from-green-900/80 via-green-800/80 to-green-700/80" />
                    ...
                    <div className="container-custom relative z-10">
                        ...
                        <div className="max-w-4xl">
                            ...
                            <div className="flex flex-wrap gap-4 mb-10">
                                {['Erfahrene Gärtner', 'Flexible Termine', 'Kurze Anfahrt', 'Entsorgung inklusive'].map((item, i) => (
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        { t: 'Kurze Anfahrt', d: `Schnell vor Ort in ${city.name}` },
            ...
            <footer className="bg-gray-900 text-gray-400 py-12">
                <div className="container-custom">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <Link href="/" className="flex items-center gap-3">
                            <img src="/images/logo.png" alt="Adler & Sohn Galabau" className="h-10 w-auto object-contain brightness-200" />
                        </Link>
