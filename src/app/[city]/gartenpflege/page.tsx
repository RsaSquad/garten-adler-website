...
const services = [{"title":"Rasenpflege","icon":"🌿","features":["Rasenmähen","Vertikutieren","Düngen","Nachsäen"]},{"title":"Heckenschnitt","icon":"✂️","features":["Formschnitt","Rückschnitt","Entsorgung"]},{"title":"Beetpflege","icon":"🌸","features":["Unkraut","Mulchen","Bepflanzung"]},{"title":"Saisonarbeiten","icon":"🍂","features":["Frühjahrsputz","Laubentfernung","Winterschutz"]}];
...
export default async function CityGartenpflegePage({ params }: { params: Promise<{ city: string }> }) {
    ...
    const faqs = selectFAQs([
        { q: `Was kostet Gartenpflege in ${city.name}?`, a: `Die Kosten richten sich nach Umfang und Material. Kontaktieren Sie uns für ein kostenloses Angebot in ${city.name}.` },
        { q: `Wie schnell sind Sie in ${city.name}?`, a: `Mit nur ${city.distance}km Anfahrt können wir meist innerhalb von 1-2 Wochen starten.` },
        { q: `Bieten Sie Gartenpflege in ganz ${city.name} an?`, a: `Ja, wir sind in ganz ${city.name} und Umgebung tätig.` },
    ...
    const jsonLd = {
        ...
        '@graph': [
            { '@type': 'Service', name: `Gartenpflege ${city.name}`, provider: { '@type': 'HomeAndConstructionBusiness', name: 'Adler & Sohn', url: 'https://garten-adler.de', telephone: '04131 - 394 2971' }, areaServed: { '@type': 'City', name: city.name } },
    ...
    return (
        <>
                ...
                <div className="container-custom py-1.5">
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-6">
                            ...
                            <Link href="/gartenpflege" className="text-white/80 hover:text-white px-4 py-2 rounded-full transition-all">Gartenpflege</Link>
            ...
            <main>
                <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-green-900 via-green-800 to-green-700">
                    <div className="container-custom relative z-10">
                        ...
                        <div className="max-w-4xl">
                            ...
                            <p className="text-xl text-white/80 leading-relaxed mb-8">Professionelle Gartenpflege: Rasenmähen, Heckenschnitt, Beetpflege und mehr.</p>
                            <div className="flex flex-wrap gap-4 mb-10">
                                {['Erfahrene Gärtner', 'Flexible Termine', 'Entsorgung inklusive'].map((item, i) => (
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <div className="text-center max-w-3xl mx-auto mb-12">
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Gartenpflege-Leistungen in {city.name}</h2>
                        </div>
                ...
                <section className="section-padding bg-gray-50">
                    <div className="container-custom">
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Warum Adler &amp; Sohn für Gartenpflege in {city.name}?</h2>
                    ...
                    <div className="container-custom">
                        <div className="max-w-3xl mx-auto">
                            ...
                            <Link href="/blog/rasen-pflege-jahresplan" className="group flex items-center gap-3 p-4 bg-white rounded-xl hover:shadow-md transition-all border border-gray-100">
                                <span className="text-2xl">📖</span>
                                <span className="text-gray-700 group-hover:text-green-600 font-medium transition-colors">Rasen düngen, mähen, vertikutieren — der Jahresplan</span>
                            ...
                            <Link href="/blog/garten-pflegeleicht-gestalten" className="group flex items-center gap-3 p-4 bg-white rounded-xl hover:shadow-md transition-all border border-gray-100">
                                <span className="text-2xl">📖</span>
                                <span className="text-gray-700 group-hover:text-green-600 font-medium transition-colors">Garten pflegeleicht gestalten: 12 Ideen</span>
                                <svg className="w-4 h-4 text-gray-400 group-hover:text-green-500 ml-auto transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                            </Link>
                            </div>
                        </div>
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">FAQ – Gartenpflege in {city.name}</h2>
                ...
                <section className="section-padding bg-gray-900 text-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold mb-8 text-center">Gartenpflege in der Region</h2>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {nearbyCities.map((nc) => (
                ...
                <section className="section-padding bg-gradient-to-r from-green-800 to-green-700">
                    <div className="container-custom text-center">
                        <h2 className="text-3xl font-bold text-white mb-6">Gartenpflege in {city.name} anfragen</h2>
