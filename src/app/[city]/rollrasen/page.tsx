...
export default async function CityRollrasenPage({ params }: { params: Promise<{ city: string }> }) {
    ...
    const jsonLd = {
        ...
        '@graph': [
            { '@type': 'Service', name: `Rollrasen ${city.name}`, provider: { '@type': 'HomeAndConstructionBusiness', name: 'Adler & Sohn', telephone: '04131 - 394 2971' }, areaServed: { '@type': 'City', name: city.name } },
