...
export async function generateMetadata({ params }: { params: Promise<{ city: string }> }): Promise<Metadata> {
    ...
    return {
        title, description,
        openGraph: { title, description, url: `https://garten-adler.de/${city.slug}/rollrasen` },
        alternates: { canonical: `https://garten-adler.de/${city.slug}/rollrasen` },
    };
}

const services = [{"title":"Rollrasen verlegen","icon":"🟢","features":["Vorbereitung","Verlegung","Pflege"]},{"title":"Bodenbearbeitung","icon":"🚜","features":["Fräsen","Einebnen","Düngen"]},{"title":"Bewässerung","icon":"💧","features":["Erstbewässerung","Systeme","Beratung"]},{"title":"Rasensanierung","icon":"🔄","features":["Nachsaat","Vertikutieren","Aerifizieren"]}];
...
export default async function CityRollrasenPage({ params }: { params: Promise<{ city: string }> }) {
    ...
    const faqs = selectFAQs([
        { q: `Was kostet Rollrasen in ${city.name}?`, a: `Die Kosten richten sich nach Umfang und Material. Kontaktieren Sie uns für ein kostenloses Angebot in ${city.name}.` },
        { q: `Wie schnell sind Sie in ${city.name}?`, a: `Mit nur ${city.distance}km Anfahrt können wir meist innerhalb von 1-2 Wochen starten.` },
        { q: `Bieten Sie Rollrasen in ganz ${city.name} an?`, a: `Ja, wir sind in ganz ${city.name} und Umgebung tätig.` },
    ...
    const jsonLd = {
        ...
        '@graph': [
            { '@type': 'Service', name: `Rollrasen ${city.name}`, provider: { '@type': 'HomeAndConstructionBusiness', name: 'Adler & Sohn', url: 'https://garten-adler.de', telephone: '04131 - 394 2971' }, areaServed: { '@type': 'City', name: city.name } },
        ...
        <>
                ...
                <div className="container-custom py-1.5">
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-6">
                            ...
                            <Link href="/rollrasen" className="text-white/80 hover:text-white px-4 py-2 rounded-full transition-all">Rollrasen</Link>
            ...
            <main>
                    ...
                    <div className="container-custom relative z-10">
                        ...
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                                Rollrasen in <span className="text-lime-300">{city.name}</span>
                            </h1>
                            <p className="text-xl text-white/80 leading-relaxed mb-8">Sofort grün: Premium-Rollrasen – verlegt an einem Tag.</p>
                            <div className="flex flex-wrap gap-4 mb-10">
                                {["Sofort grün","Premium-Qualität","Komplett-Service"].map((item, i) => (
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <div className="text-center max-w-3xl mx-auto mb-12">
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Rollrasen-Leistungen in {city.name}</h2>
                        </div>
                ...
                <section className="section-padding bg-gray-50">
                    <div className="container-custom">
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Warum Adler & Sohn für Rollrasen in {city.name}?</h2>
                ...
                <section className="section-padding bg-gray-900 text-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold mb-8 text-center">Rollrasen in der Region</h2>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {nearbyCities.map((nc) => (
                                <Link key={nc.slug} href={`/${nc.slug}/rollrasen`} className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all">
                ...
                <section className="section-padding bg-gradient-to-r from-green-800 to-green-700">
                    <div className="container-custom text-center">
                        <h2 className="text-3xl font-bold text-white mb-6">Rollrasen in {city.name} anfragen</h2>
