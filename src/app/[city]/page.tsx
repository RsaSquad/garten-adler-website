                    ...
                    <div className="container-custom relative z-10">
                        ...
                        <div className="max-w-4xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <a href="tel:+4941311234567" className="btn-outline border-white/30 text-white hover:bg-white hover:text-green-700 inline-flex items-center justify-center gap-3">
