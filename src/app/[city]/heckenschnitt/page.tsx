...
export async function generateMetadata({ params }: { params: Promise<{ city: string }> }): Promise<Metadata> {
    ...
    const title = `Heckenschnitt ${city.name} `;
    const description = `Professioneller Heckenschnitt in ${city.name}. ✓ Formschnitt ✓ Rückschnitt ✓ Rodung ✓ Neupflanzung. Jetzt anfragen!`;
    return {
        title, description,
        openGraph: { title, description, url: `https://garten-adler.de/${city.slug}/heckenschnitt` },
        alternates: { canonical: `https://garten-adler.de/${city.slug}/heckenschnitt` },
    };
}

const services = [{"title":"Formschnitt","icon":"✂️","features":["Figuren","Geometrisch","Naturform"]},{"title":"Rückschnitt","icon":"🌿","features":["Verjüngung","Auslichtung","Höhenreduzierung"]},{"title":"Rodung","icon":"🪓","features":["Entfernung","Wurzelstock","Entsorgung"]},{"title":"Neupflanzung","icon":"🌱","features":["Beratung","Sorten","Pflanzung"]}];
...
export default async function CityHeckenschnittPage({ params }: { params: Promise<{ city: string }> }) {
    ...
    const faqs = selectFAQs([
        { q: `Was kostet Heckenschnitt in ${city.name}?`, a: `Die Kosten richten sich nach Umfang und Material. Kontaktieren Sie uns für ein kostenloses Angebot in ${city.name}.` },
        { q: `Wie schnell sind Sie in ${city.name}?`, a: `Mit nur ${city.distance}km Anfahrt können wir meist innerhalb von 1-2 Wochen starten.` },
        { q: `Bieten Sie Heckenschnitt in ganz ${city.name} an?`, a: `Ja, wir sind in ganz ${city.name} und Umgebung tätig.` },
    ...
    return (
        <>
                ...
                <div className="container-custom py-1.5">
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-6">
                            ...
                            <Link href="/heckenschnitt" className="text-white/80 hover:text-white px-4 py-2 rounded-full transition-all">Heckenschnitt</Link>
            ...
            <main>
                <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-green-900 via-green-800 to-green-700">
                    <div className="container-custom relative z-10">
                        ...
                        <div className="max-w-4xl">
                            ...
                            <p className="text-xl text-white/80 leading-relaxed mb-8">Professioneller Heckenschnitt – für gepflegte Grundstücksgrenzen.</p>
                            <div className="flex flex-wrap gap-4 mb-10">
                                {["Sauberer Schnitt","Entsorgung inklusive","Terminflexibel"].map((item, i) => (
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <div className="text-center max-w-3xl mx-auto mb-12">
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Heckenschnitt-Leistungen in {city.name}</h2>
                        </div>
                ...
                <section className="section-padding bg-gray-50">
                    <div className="container-custom">
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Warum Adler & Sohn für Heckenschnitt in {city.name}?</h2>
                ...
                <section className="section-padding bg-green-50">
                    <div className="container-custom">
                        <div className="max-w-3xl mx-auto">
                            ...
                            <Link href="/blog/hecke-schneiden-wann-erlaubt" className="group flex items-center gap-3 p-4 bg-white rounded-xl hover:shadow-md transition-all border border-gray-100">
                                <span className="text-2xl">📖</span>
                                <span className="text-gray-700 group-hover:text-green-600 font-medium transition-colors">Hecke schneiden: Wann erlaubt? Gesetz & Bußgelder</span>
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">FAQ – Heckenschnitt in {city.name}</h2>
                ...
                <section className="section-padding bg-gray-900 text-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold mb-8 text-center">Heckenschnitt in der Region</h2>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {nearbyCities.map((nc) => (
                                <Link key={nc.slug} href={`/${nc.slug}/heckenschnitt`} className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all">
                ...
                <section className="section-padding bg-gradient-to-r from-green-800 to-green-700">
                    <div className="container-custom text-center">
                        <h2 className="text-3xl font-bold text-white mb-6">Heckenschnitt in {city.name} anfragen</h2>
