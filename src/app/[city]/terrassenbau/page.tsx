...
export async function generateMetadata({ params }: { params: Promise<{ city: string }> }): Promise<Metadata> {
    ...
    const title = `Terrassenbau ${city.name} `;
    const description = `Terrassenbau in ${city.name}. ✓ Holzterrassen ✓ Steinterrassen ✓ Überdachungen. Individuelle Planung & Festpreise!`;
    return {
        title, description,
        openGraph: { title, description, url: `https://garten-adler.de/${city.slug}/terrassenbau` },
        alternates: { canonical: `https://garten-adler.de/${city.slug}/terrassenbau` },
    };
}

const services = [{"title":"Holzterrassen","icon":"🪵","features":["Bangkirai","Lärche","WPC"]},{"title":"Steinterrassen","icon":"🪨","features":["Naturstein","Beton","Keramik"]},{"title":"Überdachungen","icon":"🏠","features":["Pergola","Glasdach","Markise"]},{"title":"Stufen & Treppen","icon":"🪜","features":["Blockstufen","Setzstufen","Beleuchtung"]}];
...
export default async function CityTerrassenbauPage({ params }: { params: Promise<{ city: string }> }) {
    ...
    const faqs = selectFAQs([
        { q: `Was kostet Terrassenbau in ${city.name}?`, a: `Die Kosten richten sich nach Umfang und Material. Kontaktieren Sie uns für ein kostenloses Angebot in ${city.name}.` },
        { q: `Wie schnell sind Sie in ${city.name}?`, a: `Mit nur ${city.distance}km Anfahrt können wir meist innerhalb von 1-2 Wochen starten.` },
        { q: `Bieten Sie Terrassenbau in ganz ${city.name} an?`, a: `Ja, wir sind in ganz ${city.name} und Umgebung tätig.` },
    ...
    const jsonLd = {
        ...
        '@graph': [
            { '@type': 'Service', name: `Terrassenbau ${city.name}`, provider: { '@type': 'HomeAndConstructionBusiness', name: 'Adler & Sohn', url: 'https://garten-adler.de', telephone: '04131 - 394 2971' }, areaServed: { '@type': 'City', name: city.name } },
    ...
    return (
        <>
                ...
                <div className="container-custom py-1.5">
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-6">
                            ...
                            <Link href="/terrassenbau" className="text-white/80 hover:text-white px-4 py-2 rounded-full transition-all">Terrassenbau</Link>
            ...
            <main>
                    ...
                    <div className="container-custom relative z-10">
                        ...
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                                Terrassenbau in <span className="text-lime-300">{city.name}</span>
                            </h1>
                            <p className="text-xl text-white/80 leading-relaxed mb-8">Ihre Traumterrasse – individuell geplant und fachgerecht gebaut.</p>
                            <div className="flex flex-wrap gap-4 mb-10">
                                {["Individuelle Planung","5 Jahre Garantie","Festpreise"].map((item, i) => (
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <div className="text-center max-w-3xl mx-auto mb-12">
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Terrassenbau-Leistungen in {city.name}</h2>
                        </div>
                ...
                <section className="section-padding bg-gray-50">
                    <div className="container-custom">
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Warum Adler & Sohn für Terrassenbau in {city.name}?</h2>
                ...
                <section className="section-padding bg-green-50">
                    <div className="container-custom">
                        <div className="max-w-3xl mx-auto">
                            ...
                            <Link href="/blog/wpc-oder-holz-terrasse" className="group flex items-center gap-3 p-4 bg-white rounded-xl hover:shadow-md transition-all border border-gray-100">
                                <span className="text-2xl">📖</span>
                                <span className="text-gray-700 group-hover:text-green-600 font-medium transition-colors">WPC oder Holz? Welche Terrasse hält länger</span>
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">FAQ – Terrassenbau in {city.name}</h2>
                ...
                <section className="section-padding bg-gray-900 text-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold mb-8 text-center">Terrassenbau in der Region</h2>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {nearbyCities.map((nc) => (
                                <Link key={nc.slug} href={`/${nc.slug}/terrassenbau`} className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all">
                ...
                <section className="section-padding bg-gradient-to-r from-green-800 to-green-700">
                    <div className="container-custom text-center">
                        <h2 className="text-3xl font-bold text-white mb-6">Terrassenbau in {city.name} anfragen</h2>
