...
const services = [{"title":"Gartengestaltung","icon":"🎨","features":["Planung","Neuanlage","Umgestaltung"]},{"title":"Erdbau","icon":"🚜","features":["Aushub","Auffüllung","Modellierung"]},{"title":"Entwässerung","icon":"💧","features":["Drainage","Versickerung","Regenwasser"]},{"title":"Mauerbau","icon":"🧱","features":["Trockenmauern","Stützmauern","Hochbeete"]}];
...
export default async function CityGaLaBauPage({ params }: { params: Promise<{ city: string }> }) {
    ...
    const faqs = selectFAQs([
        { q: `Was kostet GaLaBau in ${city.name}?`, a: `Die Kosten richten sich nach Umfang und Material. Kontaktieren Sie uns für ein kostenloses Angebot in ${city.name}.` },
        { q: `Wie schnell sind Sie in ${city.name}?`, a: `Mit nur ${city.distance}km Anfahrt können wir meist innerhalb von 1-2 Wochen starten.` },
        { q: `Bieten Sie GaLaBau in ganz ${city.name} an?`, a: `Ja, wir sind in ganz ${city.name} und Umgebung tätig.` },
    ...
    const jsonLd = {
        ...
        '@graph': [
            { '@type': 'Service', name: `GaLaBau ${city.name}`, provider: { '@type': 'HomeAndConstructionBusiness', name: 'Adler & Sohn', url: 'https://garten-adler.de', telephone: '04131 - 394 2971' }, areaServed: { '@type': 'City', name: city.name } },
    ...
    return (
        <>
                ...
                <div className="container-custom py-1.5">
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-6">
                            ...
                            <Link href="/galabau" className="text-white/80 hover:text-white px-4 py-2 rounded-full transition-all">GaLaBau</Link>
            ...
            <main>
                    ...
                    <div className="container-custom relative z-10">
                        ...
                        <div className="max-w-4xl">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                                GaLaBau in <span className="text-lime-300">{city.name}</span>
                            </h1>
                            <p className="text-xl text-white/80 leading-relaxed mb-8">Garten- und Landschaftsbau vom Fachbetrieb – Planung bis Fertigstellung.</p>
                            <div className="flex flex-wrap gap-4 mb-10">
                                {["Komplettplanung","Fachbetrieb","Festpreisangebote"].map((item, i) => (
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <div className="text-center max-w-3xl mx-auto mb-12">
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">GaLaBau-Leistungen in {city.name}</h2>
                        </div>
                ...
                <section className="section-padding bg-gray-50">
                    <div className="container-custom">
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">Warum Adler & Sohn für GaLaBau in {city.name}?</h2>
                ...
                <section className="section-padding bg-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">FAQ – GaLaBau in {city.name}</h2>
                ...
                <section className="section-padding bg-gray-900 text-white">
                    <div className="container-custom">
                        <h2 className="text-3xl font-bold mb-8 text-center">GaLaBau in der Region</h2>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {nearbyCities.map((nc) => (
                                <Link key={nc.slug} href={`/${nc.slug}/galabau`} className="group bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all">
                ...
                <section className="section-padding bg-gradient-to-r from-green-800 to-green-700">
                    <div className="container-custom text-center">
                        <h2 className="text-3xl font-bold text-white mb-6">GaLaBau in {city.name} anfragen</h2>
