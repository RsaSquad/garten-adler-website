...
<p><strong>Unser meistverkauftes Setup:</strong> Granit-Terrassenplatten (anthrazit, geflammt) mit Basalt-Randsteinen. Zeitlose Eleganz, null Pflegeaufwand, Lebensdauer 50+ Jahre. Eine Investition die sich bezahlt macht.</p>
    ...
    {
        slug: 'hecke-pflanzen-abstand-kosten',
        title: 'Hecke pflanzen: Abstand, Kosten & beste Jahreszeit',
        metaTitle: 'Hecke pflanzen: Abstand, Kosten & beste Jahreszeit 2026',
        metaDescription: 'Hecke pflanzen? Pflanzabstand, Kosten pro Meter, beste Jahreszeit und Sortenwahl. Profi-Ratgeber.',
        excerpt: 'Alles was Sie wissen muessen, bevor Sie eine Hecke pflanzen: Abstand, Kosten, Zeitpunkt und die richtige Sorte.',
        category: 'Ratgeber', publishDate: '2026-08-09', readingTime: 8,
        keywords: ['Hecke pflanzen Abstand', 'Hecke pflanzen Kosten', 'Hecke pflanzen wann'],
        tableOfContents: [{ id: 'abstand', title: 'Pflanzabstand' }, { id: 'kosten', title: 'Kosten' }, { id: 'zeit', title: 'Beste Jahreszeit' }],
        content: [
            { id: 'abstand', heading: 'Der richtige Pflanzabstand', content: '<table><thead><tr><th>Sorte</th><th>Pflanzen/lfm</th><th>Abstand</th></tr></thead><tbody><tr><td><strong>Hainbuche</strong></td><td>4-5</td><td>20-25 cm</td></tr><tr><td><strong>Liguster</strong></td><td>4-5</td><td>20-25 cm</td></tr><tr><td><strong>Thuja</strong></td><td>2-3</td><td>35-50 cm</td></tr><tr><td><strong>Eibe</strong></td><td>3-4</td><td>25-35 cm</td></tr><tr><td><strong>Kirschlorbeer</strong></td><td>2-3</td><td>40-50 cm</td></tr></tbody></table>' },
            { id: 'kosten', heading: 'Kosten pro laufenden Meter', content: '<table><thead><tr><th>Sorte</th><th>Pflanzen/m</th><th>Preis/Pflanze</th><th>Kosten/lfm</th></tr></thead><tbody><tr><td>Hainbuche (80cm)</td><td>4</td><td>3-7 EUR</td><td>12-28 EUR</td></tr><tr><td>Liguster (80cm)</td><td>4</td><td>3-8 EUR</td><td>12-32 EUR</td></tr><tr><td>Thuja (120cm)</td><td>3</td><td>8-15 EUR</td><td>24-45 EUR</td></tr><tr><td>Eibe (80cm)</td><td>3</td><td>10-25 EUR</td><td>30-75 EUR</td></tr></tbody></table>' },
            { id: 'zeit', heading: 'Beste Jahreszeit', content: '<ul><li><strong>Herbst (Okt-Nov):</strong> Ideal! Wurzeln wachsen den Winter ueber ein</li><li><strong>Fruehling (Maerz-Apr):</strong> Zweite Wahl, sofort waessern</li><li><strong>Container-Pflanzen:</strong> Ganzjaehrig moeglich (ausser Frost)</li></ul>' },
        ],
        faqs: [
            { q: 'Wie viele Heckenpflanzen brauche ich pro Meter?', a: '4-5 Pflanzen pro laufenden Meter bei Hainbuche und Liguster, 2-3 bei Thuja und Kirschlorbeer.' },
            { q: 'Wann ist die beste Zeit zum Hecke pflanzen?', a: 'Oktober bis November. Die Wurzeln wachsen den ganzen Winter und die Hecke startet im Fruehling voll durch.' },
        ],
        relatedServices: ['heckenschnitt', 'gartenpflege', 'garten-und-landschaftsbau'],
    },
    {
        slug: 'kirschlorbeer-verboten-alternativen',
        title: 'Kirschlorbeer verboten? Alternativen fuer die Hecke',
        metaTitle: 'Kirschlorbeer verboten? Die besten Alternativen 2026',
        metaDescription: 'Kirschlorbeer bald verboten? Warum, und welche Alternativen genauso gut sind. Profi-Empfehlungen.',
        excerpt: 'Immer mehr Gemeinden verbieten Kirschlorbeer. Warum — und welche Alternativen genauso dicht und immergruen sind.',
        category: 'Ratgeber', publishDate: '2026-08-12', readingTime: 7,
        keywords: ['Kirschlorbeer verboten', 'Kirschlorbeer Alternative', 'Kirschlorbeer Verbot'],
        tableOfContents: [{ id: 'warum', title: 'Warum wird Kirschlorbeer verboten?' }, { id: 'alternativen', title: 'Die 5 besten Alternativen' }],
        content: [
            { id: 'warum', heading: 'Warum wird Kirschlorbeer verboten?', content: '<ul><li><strong>Invasive Art:</strong> Breitet sich unkontrolliert in Waeldern aus</li><li><strong>Oekologisch wertlos:</strong> Bietet Insekten und Voegeln kaum Nahrung</li><li><strong>Giftig:</strong> Alle Pflanzenteile sind giftig (Blausaeure)</li><li><strong>Entsorgung:</strong> Darf nicht kompostiert werden — teuer als Sondermuell</li></ul>' },
            { id: 'alternativen', heading: 'Die 5 besten Alternativen', content: '<table><thead><tr><th>Alternative</th><th>Immergruen</th><th>Wuchs/Jahr</th><th>Vorteile</th></tr></thead><tbody><tr><td><strong>Eibe (Taxus)</strong></td><td>Ja</td><td>20-30 cm</td><td>Extrem schnittvertraeglich, langlebig</td></tr><tr><td><strong>Hainbuche</strong></td><td>Halb (Laub bleibt)</td><td>30-50 cm</td><td>Guenstig, robust, heimisch</td></tr><tr><td><strong>Stechpalme (Ilex)</strong></td><td>Ja</td><td>15-25 cm</td><td>Vogelnahrung, winterhart</td></tr><tr><td><strong>Glanzmispel</strong></td><td>Ja</td><td>30-40 cm</td><td>Roter Austrieb, modern</td></tr><tr><td><strong>Liguster</strong></td><td>Halb</td><td>40-60 cm</td><td>Sehr schnell dicht, guenstig</td></tr></tbody></table><p><strong>Unsere Empfehlung:</strong> Eibe. Genauso dicht und immergruen wie Kirschlorbeer, aber heimisch, schnittvertraeglich und wird 100+ Jahre alt.</p>' },
        ],
        faqs: [
            { q: 'Ist Kirschlorbeer in Deutschland verboten?', a: 'Noch nicht bundesweit, aber die EU hat Kirschlorbeer auf die Liste invasiver Arten gesetzt. Immer mehr Gemeinden verbieten Neupflanzungen. Der Trend ist klar.' },
            { q: 'Was ist die beste Alternative zu Kirschlorbeer?', a: 'Eibe (Taxus baccata). Genauso dicht und immergruen, aber heimisch, extrem schnittvertraeglich und oekologisch wertvoll.' },
        ],
        relatedServices: ['heckenschnitt', 'gartenpflege', 'garten-und-landschaftsbau'],
    },
    {
        slug: 'pool-im-garten-was-beachten',
        title: 'Pool im Garten: Genehmigung, Kosten & Planung',
        metaTitle: 'Pool im Garten: Genehmigung, Kosten & Planung 2026',
        metaDescription: 'Pool im Garten bauen? Genehmigung, Kosten, Groesse und Planung. Was Sie vor dem Poolbau wissen muessen.',
        excerpt: 'Ein eigener Pool im Garten — wir klaeren Genehmigung, Kosten und was Sie bei der Planung beachten muessen.',
        category: 'Ratgeber', publishDate: '2026-08-18', readingTime: 9,
        keywords: ['Pool Garten Genehmigung', 'Pool bauen Kosten', 'Pool Garten planen'],
        tableOfContents: [{ id: 'genehmigung', title: 'Genehmigung' }, { id: 'kosten', title: 'Kosten' }, { id: 'typen', title: 'Pool-Typen' }],
        content: [
            { id: 'genehmigung', heading: 'Brauche ich eine Baugenehmigung?', content: '<p>In den meisten Bundeslaendern sind Pools bis <strong>50 m3</strong> genehmigungsfrei. Das entspricht ca. 8x4x1,5m.</p><table><thead><tr><th>Bundesland</th><th>Genehmigungsfrei bis</th></tr></thead><tbody><tr><td>Niedersachsen</td><td>50 m3</td></tr><tr><td>Hamburg</td><td>50 m3</td></tr><tr><td>Schleswig-Holstein</td><td>50 m3</td></tr></tbody></table><p><strong>Aber:</strong> Bebauungsplan pruefen! Manche Gemeinden haben Vorgaben zur Versiegelung.</p>' },
            { id: 'kosten', heading: 'Was kostet ein Pool?', content: '<table><thead><tr><th>Pool-Typ</th><th>Kosten (komplett)</th></tr></thead><tbody><tr><td>Aufstellpool</td><td>500-3.000 EUR</td></tr><tr><td>Stahlwandpool (eingelassen)</td><td>3.000-8.000 EUR</td></tr><tr><td>GFK-Fertigbecken</td><td>8.000-20.000 EUR</td></tr><tr><td>Betonpool (individuell)</td><td>20.000-50.000+ EUR</td></tr></tbody></table><p><strong>Laufende Kosten:</strong> 500-1.500 EUR/Jahr (Strom, Wasser, Chemie, Wartung).</p>' },
            { id: 'typen', heading: 'Welcher Pool-Typ passt?', content: '<ul><li><strong>Aufstellpool:</strong> Guenstig, schnell, aber optisch nicht premium</li><li><strong>Stahlwandpool:</strong> Gutes Preis-Leistungs-Verhaeltnis, einfache Montage</li><li><strong>GFK-Fertigbecken:</strong> Schnelle Installation, glatte Oberflaeche, 30+ Jahre haltbar</li><li><strong>Betonpool:</strong> Jede Form moeglich, hoechste Qualitaet, aber teuer</li></ul>' },
        ],
        faqs: [
            { q: 'Braucht man fuer einen Pool eine Baugenehmigung?', a: 'In den meisten Bundeslaendern sind Pools bis 50 m3 genehmigungsfrei. Pruefen Sie aber den Bebauungsplan Ihrer Gemeinde.' },
            { q: 'Was kostet ein Pool im Garten komplett?', a: 'Von 3.000 EUR (Stahlwandpool) bis 50.000+ EUR (individueller Betonpool). Ein GFK-Fertigbecken liegt bei 8.000-20.000 EUR.' },
        ],
        relatedServices: ['garten-und-landschaftsbau', 'galabau', 'pflasterarbeiten'],
    },
    {
        slug: 'garten-beleuchtung-planen',
        title: 'Gartenbeleuchtung planen: Atmosphaere mit System',
        metaTitle: 'Gartenbeleuchtung planen: Ideen, Kosten & Profi-Tipps 2026',
        metaDescription: 'Gartenbeleuchtung planen? LED-Spots, Wegeleuchten, Akzentlicht. Kosten und Profi-Tipps fuer stimmungsvolles Licht.',
        excerpt: 'Die richtige Gartenbeleuchtung verwandelt Ihren Garten abends in eine Wohlfuehl-Oase. So planen Sie Licht mit System.',
        category: 'Inspiration', publishDate: '2026-08-21', readingTime: 7,
        keywords: ['Gartenbeleuchtung', 'Garten Licht Ideen', 'LED Garten', 'Gartenbeleuchtung planen'],
        tableOfContents: [{ id: 'grundlagen', title: 'Grundlagen' }, { id: 'bereiche', title: 'Licht fuer jeden Bereich' }, { id: 'kosten', title: 'Kosten' }],
        content: [
            { id: 'grundlagen', heading: '3 Lichtarten fuer den Garten', content: '<ol><li><strong>Funktionslicht:</strong> Wege, Eingang, Treppen — Sicherheit</li><li><strong>Akzentlicht:</strong> Baeume, Skulpturen, Wasserspiel — Atmosphaere</li><li><strong>Stimmungslicht:</strong> Lichterketten, Kerzen, Feuerstelle — Gemuetlichkeit</li></ol><p><strong>Regel:</strong> Weniger ist mehr. 3-5 gezielte Lichtpunkte wirken besser als 20 Strahler.</p>' },
            { id: 'bereiche', heading: 'Licht fuer jeden Bereich', content: '<table><thead><tr><th>Bereich</th><th>Leuchten-Typ</th><th>Kosten/Stueck</th></tr></thead><tbody><tr><td>Eingang</td><td>Wandleuchte, Hausnummer beleuchtet</td><td>50-200 EUR</td></tr><tr><td>Wege</td><td>Pollerleuchten, Bodenspots</td><td>30-150 EUR</td></tr><tr><td>Terrasse</td><td>Decken-Einbau, Stehleuchte</td><td>50-300 EUR</td></tr><tr><td>Baeume</td><td>Erdspiessstrahler (Uplights)</td><td>30-100 EUR</td></tr><tr><td>Wasser</td><td>Unterwasser-LED</td><td>50-200 EUR</td></tr></tbody></table>' },
            { id: 'kosten', heading: 'Kosten-Ueberblick', content: '<table><thead><tr><th>Umfang</th><th>Kosten</th></tr></thead><tbody><tr><td>Basis (5-8 Leuchten)</td><td>500-1.500 EUR</td></tr><tr><td>Mittel (10-15 Leuchten)</td><td>1.500-4.000 EUR</td></tr><tr><td>Premium (20+ Leuchten, Steuerung)</td><td>4.000-10.000 EUR</td></tr></tbody></table><p><strong>Tipp:</strong> Leerrohre beim Terrassenbau gleich mit verlegen — das spart spaeter 80% der Installationskosten!</p>' },
        ],
        faqs: [
            { q: 'Was kostet Gartenbeleuchtung?', a: 'Basis ab 500 EUR (5-8 LED-Leuchten), premium bis 10.000 EUR mit Smart-Home-Steuerung. Die groessten Kosten sind die Elektro-Installation.' },
            { q: 'Welche Gartenleuchten sind am besten?', a: 'LED-Leuchten mit IP65-Schutz und warmweissem Licht (2.700-3.000 Kelvin). Marken wie Bega, SLV oder Nordlux bieten langlebige Qualitaet.' },
        ],
        relatedServices: ['garten-und-landschaftsbau', 'galabau', 'terrassenbau'],
    },
    {
        slug: 'terrassenplatten-reinigen-hausmittel',
        title: 'Terrassenplatten reinigen: Was wirklich funktioniert',
        metaTitle: 'Terrassenplatten reinigen: Hausmittel & Profi-Methoden 2026',
        metaDescription: 'Terrassenplatten reinigen? Gruenbelag, Moos, Flecken entfernen. Was wirklich hilft — mit und ohne Hochdruckreiniger.',
        excerpt: 'Gruenbelag, Moos und Flecken auf der Terrasse? Wir zeigen was wirklich funktioniert — und was Sie lassen sollten.',
        category: 'Ratgeber', publishDate: '2026-07-06', readingTime: 7,
        keywords: ['Terrassenplatten reinigen', 'Terrasse Gruenbelag', 'Pflastersteine reinigen'],
        tableOfContents: [{ id: 'methoden', title: 'Reinigungsmethoden' }, { id: 'hausmittel', title: 'Hausmittel' }, { id: 'fehler', title: 'Haeufige Fehler' }],
        content: [
            { id: 'methoden', heading: 'Reinigungsmethoden im Vergleich', content: '<table><thead><tr><th>Methode</th><th>Wirkung</th><th>Risiko</th></tr></thead><tbody><tr><td><strong>Hochdruckreiniger</strong></td><td>Sehr gut</td><td>Kann Fugen ausspuelen, Oberflaeche beschaedigen</td></tr><tr><td><strong>Schrubber + Seife</strong></td><td>Gut</td><td>Arbeitsintensiv, aber schonend</td></tr><tr><td><strong>Spezialreiniger</strong></td><td>Sehr gut</td><td>Auf Material abstimmen!</td></tr><tr><td><strong>Dampfreiniger</strong></td><td>Gut</td><td>Schonend, aber langsam</td></tr></tbody></table>' },
            { id: 'hausmittel', heading: 'Was hilft — was nicht', content: '<ul><li><strong>Soda + Wasser:</strong> Funktioniert gut gegen Gruenbelag. 1 EL Soda auf 5L Wasser</li><li><strong>Schmierseife:</strong> Wirkt gegen leichte Verschmutzung</li><li><strong>Essig/Salz:</strong> NICHT verwenden! Auf versiegelten Flaechen verboten, greift Naturstein an</li></ul>' },
            { id: 'fehler', heading: 'Die 3 groessten Fehler', content: '<ol><li><strong>Hochdruckreiniger auf Naturstein:</strong> Zu viel Druck (ueber 100 bar) zerstoert die Oberflaeche</li><li><strong>Essig auf Kalkstein:</strong> Saeure loest den Stein auf — irreparabler Schaden</li><li><strong>Nicht nachfugen:</strong> Nach dem Hochdruckreinigen unbedingt Fugen wieder fuellen</li></ol>' },
        ],
        faqs: [
            { q: 'Wie reinigt man Terrassenplatten am besten?', a: 'Fuer die meisten Belaege: Soda-Loesung aufbringen, 30 Min einwirken lassen, mit Buerste schrubben und abspuelen. Bei starkem Belag: Hochdruckreiniger mit max. 100 bar.' },
            { q: 'Kann man Essig zum Terrassenplatten reinigen verwenden?', a: 'Nein! Essig greift Naturstein und Betonstein an und ist auf versiegelten Flaechen sogar verboten. Verwenden Sie stattdessen Soda oder spezielle Steinreiniger.' },
        ],
        relatedServices: ['pflasterarbeiten', 'terrassenbau', 'gartenpflege'],
    },
    {
        slug: 'einfahrt-pflastern-kosten',
        title: 'Einfahrt pflastern: Kosten pro m2 & Material-Guide',
        metaTitle: 'Einfahrt pflastern: Kosten pro m2, Materialien & Profi-Tipps 2026',
        metaDescription: 'Einfahrt pflastern lassen? Kosten pro m2, Materialvergleich Beton vs Naturstein, Unterbau-Anforderungen. Komplett-Guide.',
        excerpt: 'Was kostet es, eine Einfahrt pflastern zu lassen? Materialien, Kosten und worauf Sie beim Unterbau achten muessen.',
        category: 'Ratgeber', publishDate: '2026-07-21', readingTime: 8,
        keywords: ['Einfahrt pflastern Kosten', 'Einfahrt gestalten', 'Einfahrt pflastern lassen'],
        tableOfContents: [{ id: 'kosten', title: 'Kosten' }, { id: 'material', title: 'Materialien' }, { id: 'unterbau', title: 'Unterbau' }],
        content: [
            { id: 'kosten', heading: 'Kosten pro m2', content: '<table><thead><tr><th>Material</th><th>Material/m2</th><th>Verlegung/m2</th><th>Gesamt/m2</th></tr></thead><tbody><tr><td>Betonsteinpflaster</td><td>15-40 EUR</td><td>30-50 EUR</td><td>65-130 EUR</td></tr><tr><td>Natursteinpflaster</td><td>40-120 EUR</td><td>40-60 EUR</td><td>100-220 EUR</td></tr><tr><td>Rasengittersteine</td><td>10-25 EUR</td><td>25-40 EUR</td><td>50-85 EUR</td></tr></tbody></table><p><strong>Beispiel 30m2 Einfahrt:</strong> Beton 1.950-3.900 EUR, Naturstein 3.000-6.600 EUR.</p>' },
            { id: 'material', heading: 'Materialien im Vergleich', content: '<ul><li><strong>Betonsteinpflaster:</strong> Guenstig, viele Formen und Farben, 20-30 Jahre</li><li><strong>Naturstein (Granit):</strong> Edel, extrem langlebig (50-100 Jahre), teurer</li><li><strong>Rasengittersteine:</strong> Oekologisch, versickerungsfaehig, guenstig. Nicht fuer schwere Fahrzeuge</li></ul>' },
            { id: 'unterbau', heading: 'Unterbau fuer Einfahrten', content: '<p>Einfahrten muessen <strong>PKW-Belastung</strong> tragen. Der Unterbau ist deshalb dicker als bei Terrassen:</p><ul><li><strong>Tragschicht:</strong> 25-30 cm Schotter 0/32, lagenweise verdichtet</li><li><strong>Bettung:</strong> 3-5 cm Splitt 2/5</li><li><strong>Pflaster:</strong> Mindestens 8 cm dick (bei PKW)</li><li><strong>Randsteine:</strong> Zwingend noetig, mit Beton fixiert</li></ul>' },
        ],
        faqs: [
            { q: 'Was kostet es eine Einfahrt pflastern zu lassen?', a: 'Komplett mit Unterbau: Betonpflaster 65-130 EUR/m2, Naturstein 100-220 EUR/m2. Eine 30m2 Einfahrt kostet also 1.950-6.600 EUR.' },
            { q: 'Welches Pflaster ist am besten fuer Einfahrten?', a: 'Fuer Langlebigkeit: Granitpflaster. Fuer Preis-Leistung: Betonsteinpflaster mit mindestens 8 cm Dicke. Fuer Oekologie: Rasengittersteine.' },
        ],
        relatedServices: ['pflasterarbeiten', 'garten-und-landschaftsbau', 'galabau'],
    },
    {
        slug: 'gartenweg-anlegen-ideen',
        title: 'Gartenweg anlegen: 8 Ideen von rustikal bis modern',
        metaTitle: 'Gartenweg anlegen: 8 Ideen & Materialien im Vergleich 2026',
        metaDescription: 'Gartenweg anlegen? 8 Ideen von Naturstein bis Rindenmulch. Materialien, Kosten und Gestaltungstipps vom Profi.',
        excerpt: 'Ein schoener Gartenweg verbindet Bereiche und setzt Akzente. 8 Ideen fuer jeden Stil und jedes Budget.',
        category: 'Inspiration', publishDate: '2026-08-06', readingTime: 7,
        keywords: ['Gartenweg anlegen', 'Gartenweg Ideen', 'Gartenweg Material'],
        tableOfContents: [{ id: 'ideen', title: '8 Ideen' }, { id: 'kosten', title: 'Kosten' }],
        content: [
            { id: 'ideen', heading: '8 Gartenweg-Ideen', content: '<h3>1. Naturstein-Trittplatten</h3><p>Einzelne Natursteinplatten im Rasen — natuerlich, elegant, guenstig.</p><h3>2. Kiesweg mit Einfassung</h3><p>Kies zwischen Stahlkanten — modern, wasserdurchlaessig, pflegeleicht.</p><h3>3. Pflastersteine (Fischgraet)</h3><p>Klassisches Fischgraetmuster — zeitlos, robust, fuer jeden Gartenstil.</p><h3>4. Holzhackschnitzel/Rindenmulch</h3><p>Natuerlich, weich, sehr guenstig. Muss alle 2 Jahre erneuert werden.</p><h3>5. Betonplatten (grossformatig)</h3><p>60x60 oder 80x80 Platten — modern, minimalistisch.</p><h3>6. Natursteinpflaster (Kopfstein)</h3><p>Rustikaler Charme — perfekt fuer Landhausgaerten.</p><h3>7. Cortenstahl-Stufen</h3><p>Fuer Hanglagen — moderner Industrial-Look.</p><h3>8. Leuchtende Wegplatten</h3><p>Solarplatten die nachts leuchten — Hingucker und praktisch.</p>' },
            { id: 'kosten', heading: 'Kosten pro laufenden Meter (1m breit)', content: '<table><thead><tr><th>Material</th><th>Kosten/lfm</th></tr></thead><tbody><tr><td>Rindenmulch</td><td>5-15 EUR</td></tr><tr><td>Kiesweg</td><td>15-35 EUR</td></tr><tr><td>Trittplatten im Rasen</td><td>20-50 EUR</td></tr><tr><td>Betonpflaster</td><td>40-80 EUR</td></tr><tr><td>Natursteinpflaster</td><td>60-150 EUR</td></tr></tbody></table>' },
        ],
        faqs: [
            { q: 'Was kostet ein Gartenweg?', a: 'Von 5 EUR/lfm (Rindenmulch) bis 150 EUR/lfm (Natursteinpflaster). Ein 10m langer Weg kostet also 50-1.500 EUR.' },
            { q: 'Wie breit sollte ein Gartenweg sein?', a: 'Hauptwege: 1,20 m (2 Personen nebeneinander). Nebenwege: 60-80 cm. Zum Gartenhaus/Garage: mindestens 1,50 m.' },
        ],
        relatedServices: ['pflasterarbeiten', 'garten-und-landschaftsbau', 'galabau'],
    },
];
